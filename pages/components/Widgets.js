  ...
  return (
    ...
    <div className="w-[90%] xl:w-[75%] sticky top-0 bg-white py-1.5 z-50 ">
        <div className="flex items-center p-3 rounded-full bg-red-300 relative">
            ...
            <input className="absolute inset-0 rounded-full pl-11 border-gray-500 text-gray-700 focus:bg-white focus:shadow-lg bg-gray-100" type="text" placeholder="Search Twitter" />
        </div>
    </div>
      ...
      <div className="text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%] ">
        ...
        <button onClick={()=>setArticleNum(articleNum + 3)} className=" text-blue-300 pl-4 pb-3 hover:text-blue-300 ">Show more</button>
      </div>
          <div className=" sticky top-16 text-gray-700 space-y-3 bg-gray-100 rounded-xl pt-2 w-[90%] xl:w-[75%] ">
            ...
            <button onClick={()=>setRandomUserNum(randomUserNum + 3)} className=" text-blue-300 pl-4 pb-3 hover:text-blue-300 ">Show more</button>
          </div>
    </div>
  )
}
